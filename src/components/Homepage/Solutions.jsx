        ...
        <div className="py-32" style={{ backgroundImage: "linear-gradient(0deg, rgba(241, 246, 253, 0) 1.63%, #F1F6FD 20.5%, #F1F6FD 58.57%, #FFFFFF 100%)" }}>
            <BaseContainer>
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1">
                    {
                        solutions.map(solution => <div className="flex lg:flex-row flex-col bg-white shadow-lg lg:w-[60%] w-full mr-auto ml-auto py-10 px-5 mb-4" data-aos="fade-up" data-aos-delay="400">
                            <div>
